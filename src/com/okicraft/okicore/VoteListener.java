...
public class VoteListener implements Listener
{
    ...
    public void onVotifierEvent( VotifierEvent event )
    {
        ...
        if( p != null )
        {
            Bukkit.getServer().broadcastMessage( OkiCore.getMol() + "Yay! " + p.getDisplayName() + " voted for LoyLoy, just " + ChatColor.YELLOW + (VOTES_PER_REWARD - votes) + ChatColor.WHITE + " more until we have a party :D" );
        ...
        {
            Bukkit.getServer().broadcastMessage( OkiCore.getMol() + "Yay! " + vote.getUsername() + " voted for LoyLoy, just " + ChatColor.YELLOW + (VOTES_PER_REWARD - votes) + ChatColor.WHITE + " more until we have a party :D" );
        }
        ...
        if( votes == VOTES_PER_REWARD )
        {
            ...
            for( Player player : Bukkit.getServer().getOnlinePlayers() )
            {
                ...
                player.sendMessage( OkiCore.getPfx() + subTitle );
