...
public class ResurrectCommand implements CommandExecutor
{
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args)
    {
        ...
        if( name.equals("all") || name.equals( "*" ) )
        {
            ...
            sender.sendMessage( OkiCore.getPfx() + "You resurrected everyone!.. Did Io approve?..");
            return true;
        }
        ...
        {
            sender.sendMessage(OkiCore.getPfx() + ChatColor.RED + name + " has not played before...");
            return true;
        }
        ...
        sender.sendMessage(OkiCore.getPfx() + name + " is alive again!");
